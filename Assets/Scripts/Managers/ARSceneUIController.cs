...
public class ARSceneUIController : MonoBehaviour
{
    ...
    const string k_MoveDeviceText = "Scan floor slowly";
    const string k_TouchToDrawText = "Touch screen to start drawing";
